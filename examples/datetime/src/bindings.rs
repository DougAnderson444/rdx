...
pub mod component {
    ...
    pub mod plugin {
        ...
        pub mod host {
            ...
            pub fn sleep(self_: &Pollable, ms: u64) -> Pollable {
                unsafe {
                    #[cfg(target_arch = "wasm32")]
                    #[link(wasm_import_module = "component:plugin/host")]
                    extern "C" {
                    ...
                    let ret = wit_import((self_).handle() as i32, _rt::as_i64(&ms));
...
\0asm\x0d\0\x01\0\0\x19\x16wit-component-encoding\x04\0\x07\xd7\x03\x01A\x02\x01\
...
\x03\0\0\x08pollable\x01B\x0c\x02\x03\x02\x01\x02\x04\0\x05event\x03\0\0\x02\x03\
\x02\x01\x03\x04\0\x08pollable\x03\0\x02\x01@\x01\x03evt\x01\x01\0\x04\0\x04emit\
\x01\x04\x01@\0\0x\x04\0\x03now\x01\x05\x01h\x03\x01i\x03\x01@\x02\x04self\x06\x02\
msw\0\x07\x04\0\x05sleep\x01\x08\x03\x01\x15component:plugin/host\x05\x04\x03\0\x05\
event\x03\0\x02\x01B\x05\x01@\0\0s\x04\0\x04load\x01\0\x04\0\x08datetime\x01\0\x01\
@\0\x01\0\x04\0\x06ticker\x01\x01\x04\x01\x14component:plugin/run\x05\x06\x04\x01\
