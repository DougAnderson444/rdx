            ...
            pub mod run {
                ...
                macro_rules! __export_component_plugin_run_cabi {
                    ($ty:ident with_types_in $($path_to_types:tt)*) => {
                        ...
                        __post_return_datetime::<$ty > (arg0) } };
                    };
                }
                #[doc(hidden)]
...
\x05event\x03\0\0\x01@\x01\x03evt\x01\x01\0\x04\0\x04emit\x01\x02\x01@\0\0x\x04\0\
\x03now\x01\x03\x03\x01\x15component:plugin/host\x05\x02\x03\0\x05event\x03\0\x01\
\x01B\x03\x01@\0\0s\x04\0\x04load\x01\0\x04\0\x08datetime\x01\0\x04\x01\x14compo\
nent:plugin/run\x05\x04\x04\x01\x1dcomponent:plugin/plugin-world\x04\0\x0b\x12\x01\
